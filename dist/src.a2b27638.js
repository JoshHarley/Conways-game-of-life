...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/life.js":[function(require,module,exports) {
"use strict";
...
function liveNeighbours(x, y, board) {
  var count = 0;
  for (var _i = 0, _arr = [[+x - 1, +y - 1], [+x, +y - 1], [+x + 1, +y - 1], [+x - 1, +y], [+x + 1, +y], [+x - 1, +y + 1], [+x, +y + 1], [+x + 1, +y + 1]]; _i < _arr.length; _i++) {
...
function stepGame(board) {
  ...
  for (var y = 0; y < board.length; y++) {
    ...
    for (var x = 0; x < board.length; x++) {
      var neighbours = liveNeighbours(x, y, board);
      var alive = isAlive(x, y, board);
      if (alive) {
...
var w = 10;
var h = 10;
var board = (0, _life.emptyBoard)(w, h);
function render() {
  ...
  var _loop = function _loop(y) {
    ...
    var _loop2 = function _loop2(x) {
      ...
      if ((0, _life.isAlive)(x, y, board)) {
        cell.classList.add("alive");
      }
      function handler(evt) {
        (0, _life.toggleCell)(x, y, board);
        render();
      }
  ...
  stepButton.onclick = function (evt) {
    board = (0, _life.stepGame)(board);
    render();
  };
  gameDiv.append(stepButton);
}
render();
},{"./styles.css":"src/styles.css","./life.js":"src/life.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
